 ...
 * If your labels are integers (e.g. classification problems), 
 * please use the {@code DataSet} class.
 * 
 * @author Mingjie Qian
 * @version 1.0 May 3rd, 2015
 */
public class Data {
	 ...
	 */
	public static void writeDataSet(Matrix X, double[] Y, String filePath) {
		PrintWriter pw = null;
		try {
	 ...
	 */
	public static ArrayList<String> writeDataSet(Matrix X, double[] Y) {
	 ...
	 * 
	 */
	public static Data readDataSetFromStringArray(ArrayList<String> feaArray) throws InvalidInputDataException {
		...
		Iterator<Double> iter = vy.iterator();
		rIdx = 0;
		while (iter.hasNext()) {
			Y[rIdx] = iter.next();
			rIdx++;
	 ...
	 * @throws InvalidInputDataException
	 */
	public static Data readDataSet(ArrayList<String> feaArray) throws InvalidInputDataException {
	 ...
	 * 
	 */
	public static Data readDataSetFromFile(String filePath) throws IOException, InvalidInputDataException {
	 ...
	 * @throws InvalidInputDataException
	 */
	public static Data readDataSet(String filePath) throws IOException, InvalidInputDataException {
