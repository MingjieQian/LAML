 ...
 * <code>
 * double lambda = 0.5;</br>
 * AcceleratedProximalGradient.prox = new ProxL1(lambda); // Set the proximal mapping 
 * function, here h(X) = lambda * ||X||_1</br>
 ...
 * double hval = ...; // Initial objective function value for h(X)</br>
 * </br>
 ...
 * &nbsp hval = ...; // Compute the new objective function value for h(X) at the updated X</br>
...
public class AcceleratedProximalGradient {
	 ...
	 * 
	 */
	public static boolean[] run(Matrix Grad_t, double gval_t, double hval_t, double epsilon, Matrix X_t) {
